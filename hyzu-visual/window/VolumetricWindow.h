...
#pragma once
#ifndef HYZU_VOLWINDOW_H
#define HYZU_VOLWINDOW_H
#define GLEW_STATIC
...
public:
	VolumetricWindow(int width, int height, const std::string& title);
